...
import Exceptions.DayClosedException;
import Exceptions.FlightIsFullException;
import Exceptions.ImpossibleReservationException;
...
public class Company {
    ...
    private List<Flight> recurrentFlights;
    private Map<LocalDate, Day> flightCalendar;
    ...
    public int makeReservation(String username, List<Pair<String,String>> flights, LocalDate start, LocalDate end) throws ImpossibleReservationException, NoFlightFoundException, DayClosedException, FlightIsFullException {
        ...
        try {
            ...
            for (Pair<String, String> flight : flights) {
                ...
                while (!flightReserved && actual.isBefore(end.plusDays(1))) {
